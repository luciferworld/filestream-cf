...
const BOT_TOKEN = "6988190080:AAGQyZ5xtF3Sas0TKFG1GUC0WMc8UnPPb-s"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "asdflkjh"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 5390385209; // Insert your telegram account id.
const BOT_CHANNEL = -1001805072460; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "cRULTi6brudzqT8tocb3"; // Insert a powerful secret text and keep it safe.
